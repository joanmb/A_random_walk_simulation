...
Now, let's gonna do some interpretation about these variables. We write a code to generate 10000 observations of each of these variables. Afterwards, we gonna normalize these values considering $\tau / n$ and $\gamma / n$. Finally, we gonna make an histogram of the normalized variables.
...
hist_tau <- ggplot(df_tau_gamma, aes(x = tau_norm)) + 
    geom_histogram(binwidth = 0.025, fill="#69b3a2", color="#e9ecef", alpha=0.8) +
...
hist_gamma <- ggplot(df_tau_gamma, aes(x = gamma_norm)) + 
    geom_histogram(binwidth = 0.025, fill="#FF0033", color="#e9ecef", alpha=0.8) +
